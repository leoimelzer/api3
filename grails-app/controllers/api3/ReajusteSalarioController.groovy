...
class ReajusteSalarioController implements ControllerExceptionHandler {
    ...
    Object list() {
        String url = "${Api2Config.reajusteSalarioUrl}${Api2Config.listAction}"
    ...
    Object get(Long id) {
        String url = "${Api2Config.reajusteSalarioUrl}${Api2Config.getAction}?id=${id}"
        RestResponse resp = rest.get(url)
        JSONObject jsonResp = resp.json as JSONObject
    ...
    Object save() {
        String url = "${Api2Config.reajusteSalarioUrl}${Api2Config.saveAction}"
    ...
    Object update(Long id) {
        String url = "${Api2Config.reajusteSalarioUrl}${Api2Config.updateAction}?id=${id}"
    ...
    Object delete(Long id) {
        String url = "${Api2Config.reajusteSalarioUrl}${Api2Config.deleteAction}?id=${id}"
